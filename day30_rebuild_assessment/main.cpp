...
void runDifferentialDriveDemo() {
	...
	const RobotCommand robotCommand =
		convertWheelCommandToRobotCommand(wheelCommand, wheelRadius, wheelBase);
	...
	std::cout << "Computed linear velocity: " << robotCommand.v << " m/s\n";
	std::cout << "Computed angular velocity: " << robotCommand.omega << " rad/s\n";
...
void runManipulatorDemo() {
	...
	std::vector<JointState> threeJointArm = {
		{"shoulder", 0.0, 0.5}, {"elbow", 0.0, 0.3},
		{"wrist", 0.0, 0.2}
	};
...
int main() {
	std::cout << "Day 30 Robotics Simulation Rebuild\n";
	std::cout << "====================================\n";
